  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card p-4 shadow-sm sm:p-6 space-y-4">
              ...
              <div className="rounded-lg border border-border">
                ...
                <div className="divide-y divide-border max-h-[300px] overflow-y-auto">
                    ...
                    <div key={idx} className="flex items-center justify-between px-4 py-2 hover:bg-muted/50 transition-colors">
                      ...
                      <div className="flex shrink-0 gap-1">
                        <button
                          ...
                          className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-muted-foreground hover:bg-blue-500/10 hover:text-blue-500 transition-colors"
                        >
                  ...
                  {googleResults.length === 0 && (
                    <p className="px-4 py-4 text-center text-xs text-muted-foreground">결과 없음</p>
                  )}
                </div>
              </div>
        ...
        {!searching && !hasSearchResults && !searchedKeyword && (
                    ...
                    <tr key={kw.id} className="border-b border-border hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex justify-end gap-1">
                          ...
                          <button
                            onClick={() => handleWritePost(kw.keyword)}
                            className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-muted-foreground hover:bg-primary/10 hover:text-primary transition-colors"
                          >
                            <PenLine className="h-3 w-3" />
                            글쓰기
